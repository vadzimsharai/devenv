...
--             local float_width = (vim.tbl_get(opts, "float", "minimap_width") or
--                                     20) + 2
--             if vim.opt.sidescrolloff:get() < float_width then
--                 vim.opt.sidescrolloff = float_width
--             end
--         end
--         vim.g.neominimap = require("astrocore").extend_tbl(opts, {
